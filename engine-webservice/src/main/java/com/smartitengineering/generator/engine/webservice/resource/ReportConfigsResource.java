...
//    Collection<com.smartitengineering.generator.engine.domain.ReportConfig> reportConfigs = Services.getInstance().getReportConfigService(
...
//    Collection<com.smartitengineering.generator.engine.domain.ReportConfig> configs = Services.getInstance().getReportConfigService().getAll();
//
