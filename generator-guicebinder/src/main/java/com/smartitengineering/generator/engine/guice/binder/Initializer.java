...
public final class Initializer {
  ...
  public static final String PROP_FILE = "com/smartitengineering/generator/engine/binder/guice/modules.properties";
  ...
  public static void init() {
    ...
    mainPropertiesLocator.setSmartLocations(properties.getProperty(APIModule.WORKSPACE_PROPS));
    ...
    String workspaceIdName = mainProps.getProperty("com.smartitengineering.generator.engine.domains.workspaceId.name",
                                                   "");
    ...
    try {
      InputStream stream = classLoader.getResourceAsStream(
          "com/smartitengineering/generator/engine/domain/domain-content-type.xml");
      if (stream == null) {
